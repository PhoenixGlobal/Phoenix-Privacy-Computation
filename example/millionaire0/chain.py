...
def submit(msg):
    ...
    transaction = privacyContract.functions.submit(roundId, mybyte).buildTransaction({'gas':300000,"gasPrice": gasPrice, 'nonce':nonce })
